...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('elwhite',0,'recruit','Posterunkowy',20,'{}','{}'),
	('elwhite',1,'officer','Sierżant',40,'{}','{}'),
	('elwhite',2,'sergeant','Aspirant',60,'{}','{}'),
	('elwhite',3,'lieutenant','Komisarz',85,'{}','{}'),
	('elwhite',4,'boss','Generalny Inspektor',100,'{}','{}')
;
